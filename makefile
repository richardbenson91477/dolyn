...
SRC_G4U_Q = dolen_g4u_quantize.c dolen_g4u_common.c dolen_q_common.c dolen_common.c
INC_G4U_Q = dolen_g4u_common.h dolen_q_common.h dolen_common.h
...
wip: $(BIN_G4U)
	./$(BIN_G4U) -m $(MODEL_G4U) -tk $(TOKENIZER_G4U) -p "1 to 10: 1, 2, 3, 4, " -n 1024 -t 0.1 -M generate
